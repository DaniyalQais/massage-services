        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <p className="text-sage-700 text-lg mb-8 leading-relaxed">
              At Serenity Touch Massage, we believe that true wellness begins with a calm mind and a relaxed body. Founded in California, our mission has always been to provide a holistic approach to stress relief and physical health.
            </p>
